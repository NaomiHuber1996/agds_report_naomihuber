...
```
Unfortunately, I had as well the problem that I could not knit this code because of an error message which I could not identify after several hours. Thus, I knit it with hashtag-symbols in front to show you, that I can run the code on my laptop, but I cannot knit it to an html-file.
